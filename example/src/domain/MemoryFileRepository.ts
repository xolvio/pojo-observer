...
export class MemoryFileRepository implements IFileRepository {
  ...
  constructor() {
    ...
    this.files.push(new File(`File ${this.getNextFileNumber()}`, '/src/', lorem1))
    this.files.push(new File(`File ${this.getNextFileNumber()}`, '/test/', lorem2))
    this.files.push(new File(`File ${this.getNextFileNumber()}`, '/lib/', lorem3))
    this.files.push(new File(`File ${this.getNextFileNumber()}`, '/dist/', lorem4))
  }
